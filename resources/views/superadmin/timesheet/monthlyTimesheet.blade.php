...
@section('title','Monthly Attendance | Micro Aire-Care')
@section('body')
...
<div class="main-panel">
    <div class="content-wrapper pb-0">
     ...
     <button class="add btn btn-primary font-weight-bold todo-list-add-btn" id="resetSalesOrdersFilter">Reset</button>
                ...
                <!-- <div class="d-flex">
                    <label for="salesOrdersName" id="searchLabel" class="text-white bg-primary fw-bold">Employee </label>
                ...
                <div class="d-flex">
                    <!-- <a href="#" onclick="jQuery('delOrdersAlert').hide()" id="newbutton" class="btn btn-sm ml-3" data-toggle="modal" data-target="#createCustomerPage"> Get </a> -->
                    <!-- Default checked -->
