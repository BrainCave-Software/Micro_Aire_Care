        ...
        <table class="table text-center">
            ...
            <thead>
                <tr>
                    ...
                    <th class="border border-secondary">Task Description</th>
                    <th class="border border-secondary">Pending Task</th>
                    <th class="border border-secondary">Completed Task</th>
