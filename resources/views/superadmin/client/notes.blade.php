    ...
    <form method="post" id="createNotesForm">
        ...
        <div class="modal-body bg-white px-3">
            ...
            <div class="form-group row">
                <input type="text" id="clientNoteId" name="clientnoteid" style="display: none;">
                
                    <label for="title" class="col-md-2 col-form-label">Remarks</label>
...
<script>
            ...
            success: function(response) {
                ...
                jQuery.each(response, function(key, value) {
                    ...
                    $('.listNotes').append('<tr>\
                        ...
                        <td class=" border border-secondary"><a name="deleteNotes" data-toggle="" data-target="#" data-id="' + value["id"] + '" data-customerId="' + customer_id + '" > <i class="mdi mdi-delete"></i> </a></td>\
                    </tr>');
                });
            }
        });
    ...
    $(document).on("click", "a[name = 'deleteNotes']", function(e) {
        let id = $(this).data("id");
