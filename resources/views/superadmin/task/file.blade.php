<div class="border border-secondary">
    ...
    <form method="post" enctype="multipart/form-data" id="createProjectFileForm">
        @csrf
        <div class=" form-group row">
            <!-- hiden customer id -->
            <input type="text" id="projectFileeId" value="{{$data->customer_id}}"  name="clientfileid"  style="display: none;" >

            <!--  Project name  -->
            <div class="col-sm-3 col-form-label">Project Name </div>
            <div class="col-sm-4"><input type="text" class="form-control text-dark" id="addFileProjectNameId" name="addfileprojectname" placeholder="Project Name" /></div>
            <!--  Mobile  -->
...
<script>
    ...
    $(document).ready( function(e) {
        let customer_id = $('#projectFileeId').val();
            ...
            success: function(response) {
                ...
                jQuery.each(response, function(key, value) {
                    ...
                    $('.listfiles').append('<tr>\
                        ...
                        <td class="p-2 border border-secondary">' + value["file"] + '</td>\
            ...
            $.get(finalURL, function(response) {
                ...
                jQuery.each(response.data, function(key, value) {
                    $('.listfiles').append('<tr>\
                        ...
                        <td class="border border-primary"><a name="deletePfiles" data-toggle="" data-target="#" data-id="' + value["id"] + '" data-customerId="' + customer_id + '"> <i class="mdi mdi-delete"></i> </a></td>\
                    </tr>');
                });
                $('.files-pagination-refs').html('');
                jQuery.each(response.links, function(key, value) {
